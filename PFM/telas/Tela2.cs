...
namespace PFM.telas
{
    public partial class Tela2 : UserControl
    {
        ...
        private void check_fraSup1_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void check_fraSup2_CheckedChanged_1(object sender, EventArgs e)
        {
            trocarFracao2(tableLayoutPanel_fraSup2, check_fraSup2, fraSuperior2);
        }

        private void check_fraInf2_CheckedChanged_1(object sender, EventArgs e)
        {
