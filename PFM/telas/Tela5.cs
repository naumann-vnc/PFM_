...
namespace PFM.telas
{
    public partial class Tela5 : UserControl
    {
        public Tela5()
        {
            InitializeComponent();
        ...
        private void btn_calcular_Click(object sender, EventArgs e)
        {
            ...
            lbl_c11.Text = Convert.ToString(matriz1[0, 0] + matriz2[0, 0]);
            lbl_c12.Text = Convert.ToString(matriz1[0, 1] + matriz2[0, 1]);
            lbl_c13.Text = Convert.ToString(matriz1[0, 2] + matriz2[0, 2]);
            //
            lbl_c21.Text = Convert.ToString(matriz1[1, 0] + matriz2[1, 0]);
            lbl_c22.Text = Convert.ToString(matriz1[1, 1] + matriz2[1, 1]);
            lbl_c23.Text = Convert.ToString(matriz1[1, 2] + matriz2[1, 2]);
            //
            lbl_c31.Text = Convert.ToString(matriz1[2, 0] + matriz2[2, 0]);
            lbl_c32.Text = Convert.ToString(matriz1[2, 1] + matriz2[2, 1]);
            lbl_c33.Text = Convert.ToString(matriz1[2, 2] + matriz2[2, 2]);
